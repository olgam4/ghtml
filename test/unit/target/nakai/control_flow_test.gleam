...
pub fn generate_if_true_only_test() {
  ...
  should.be_true(string.contains(code, "False -> html.Nothing"))
}
...
pub fn generate_if_else_test() {
  ...
  should.be_true(string.contains(code, "html.Text(\"Active\")"))
  should.be_true(string.contains(code, "html.Text(\"Inactive\")"))
}
...
pub fn generate_each_without_index_test() {
  ...
  // Nakai uses Fragment instead of keyed
  should.be_true(string.contains(code, "html.Fragment("))
...
pub fn generate_nested_each_test() {
  ...
  // Should have nested html.Fragment/list.map
  let fragment_count = string.split(code, "html.Fragment(") |> list.length()
  should.be_true(fragment_count >= 3)
}
