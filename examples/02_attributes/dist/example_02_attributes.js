...
class Runtime {
  ...
  emit(event2, data2) {
    ...
    target2.dispatchEvent(new CustomEvent(event2, {
      detail: data2,
      bubbles: true,
      composed: true
    }));
...
// build/dev/javascript/example_02_attributes/components/checkbox_field.mjs
function render(label2, is_checked) {
  return label(toList([class$("checkbox")]), toList([
    input(toList([type_("checkbox"), checked(is_checked)])),
    span(toList([]), toList([text2(label2)]))
  ]));
}

// build/dev/javascript/example_02_attributes/components/form_field.mjs
function render2(label2, value2, hint) {
  return div(toList([class$("field")]), toList([
    label(toList([class$("label")]), toList([text2(label2)])),
    input(toList([
      type_("text"),
      class$("input"),
      value(value2),
...
// build/dev/javascript/example_02_attributes/components/link_button.mjs
function render3(url, label2, is_external) {
  return a(toList([
    href(url),
    class$("btn"),
    target((() => {
...
function view() {
  return div(toList([]), toList([
    ...
    div(toList([class$("section")]), toList([
      ...
      render3("/about", "Internal Link", false),
      render3("https://gleam.run", "Gleam Website", true),
      render3("https://lustre.build", "Lustre Docs", true)
    ]))
  ]));
}
function main() {
...
// build/dev/javascript/example_02_attributes/example_02_attributes.mjs
function main2() {
  return main();
}

// .lustre/build/example_02_attributes.mjs
main2();
